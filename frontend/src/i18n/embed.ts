...
// WikiBrowser 复用自知识库编辑器的图谱视图，这里补充 embed i18n 缺失的 knowledgeEditor.wikiBrowser 命名空间
const wikiBrowserZhCN = {
  searchPlaceholder: '搜索 Wiki 页面...',
  searchNoResults: '未找到匹配的 Wiki 页面',
  viewModeToggle: '切换目录视图',
  viewTree: '树形视图',
  viewList: '列表视图',
  loadMore: '加载更多（剩 {remaining} 个）',
  filterAll: '全部类型',
  newFolder: '新建文件夹',
  ...
  deleteFolderNotEmpty: '文件夹不为空，请先移除其中的页面和子文件夹',
  moveFolderSuccess: '文件夹已移动',
  moveFolderFailed: '移动文件夹失败',
  moveFolderIntoSelf: '不能将文件夹移动到自身或其子文件夹中',
  moveConfirm: '移动到「{target}」？',
  moveConfirmTitle: '确认移动',
  rootFolderLabel: '根目录',
  dropToRoot: '拖拽到此处移动到根目录',
  filterSummary: '摘要',
  filterKnowledge: '知识',
  filterEntity: '实体',
  filterConcept: '概念',
  ...
  viewReader: '阅读器',
  viewGraph: '图谱',
  stats: '{pages} 个页面 · {links} 条链接',
  emptyTitle: '暂无 Wiki 页面',
  emptyDesc: '上传并启用 Wiki 的文档后，会自动生成知识页面',
  selectPageHint: '请从左侧选择一个页面以查看其内容',
  version: 'v{ver}',
  aliases: '别名',
  linksTo: '链接到',
  linkedFrom: '被链接自',
  ...
  graphNoData: '暂无图谱数据，请先上传文档。（此处展示 Wiki 页面之间的链接关系，与「知识库设置 → 知识图谱」中配置的实体关系图谱不同。）',
  showArrows: '显示箭头',
  hideArrows: '隐藏箭头',
  expandNeighbors: '展开邻居',
  bloomNeighbors: '泛出邻居',
  growFrontier: '扩展前沿（{count}）',
  growFrontierTitle: '一键展开全部 {count} 个虚线环节点',
  cardEgoTitle: '当前焦点',
  cardOverviewTitle: '知识库概览',
  cardOverviewPrimary: '{returned} / {total} 个节点',
  cardOverviewHintTruncated: '双击任意节点可聚焦其 subgraph',
  cardOverviewHintFull: '已展示知识库中的每一个节点',
  ...
  helpDblClickDesc: '聚焦该节点',
  helpShiftClickAction: 'Shift + 单击',
  helpShiftClickDesc: '在画布上泛出邻居',
  helpHoverPlusAction: '悬停 → ⊕',
  helpHoverPlusDesc: '等同于 Shift + 单击',
  helpDragAction: '拖拽节点',
  helpDragDesc: '移动节点位置',
  helpPanAction: '拖拽空白',
  helpPanDesc: '平移画布',
  helpZoomAction: '滚轮',
  helpZoomDesc: '缩放画布',
  neighborsProgress: '已显示 {visible} / {total} 个邻居（{hidden} 个未加载）',
  neighborsAllShown: '全部 {total} 个邻居都已在画布上（点击「展开」聚焦该节点的 subgraph）',
  neighborsNone: '该页面没有关联的邻居',
  neighborsCenterUnreachable: '已显示 {visible} / {total} 个邻居（{hidden} 个不可达：死链、被过滤或已删除）',
  neighborsOverviewHidden: '已显示 {visible} / {total} 个邻居（{hidden} 个在概览之外 —— 点击「展开」可在此处透视）',
  backToOverview: '返回概览',
  healthCheck: '健康检查',
  queueStatus: 'Wiki 队列中有 {count} 个待处理任务',
  issueTitle: '该页面有 {count} 个待处理的知识冲突或错误',
  issueFixBtn: 'AI 自动修复',
  issueMixed: '信息混杂',
  issueConflict: '事实冲突',
  issueOutdated: '信息过时',
  issueAttention: '需要关注',
  issueReportedBy: '由 {reporter} 上报',
  issueAiLinter: 'AI 审查',
  issueIgnore: '忽略误报',
  globalIssuesTitle: '全局待处理内容问题',
  globalIssuesCount: '{count} 个待处理内容问题',
  globalIssuesEmpty: '暂无待处理内容问题',
  issuePagePrefix: '页面：',
  issueGoFix: '去修复',
...
const i18n = createI18n({
  ...
  messages: {
    'zh-CN': {
      ...messages['zh-CN'],
      knowledgeEditor: { wikiBrowser: wikiBrowserZhCN },
    },
    'en-US': {
      ...messages['en-US'],
      knowledgeEditor: { wikiBrowser: wikiBrowserEnUS },
    },
    'ko-KR': deepMerge(deepMerge(messages['en-US'], koEmbedPublish), {
      knowledgeEditor: { wikiBrowser: wikiBrowserKoKR },
    }),
    'ru-RU': deepMerge(deepMerge(messages['en-US'], ruEmbedPublish), {
      knowledgeEditor: { wikiBrowser: wikiBrowserRuRU },
    }),
  },
})
